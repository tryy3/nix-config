...
@test "add host.yaml file" {
	...
	# Also add a host key for 'bob' so the creation rules
	# generated by sops_setup_user_age_key can reference it
	sops_update_age_key hosts bob "${AGE_STATIC_HOST_KEY}"
